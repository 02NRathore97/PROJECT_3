					...
					<div class="card input-group-addon">
						<div class="card-body">
							<%
								...
								if (id>0) {
							%>
							<h3 class="text-center text-warning font-weight-bold">Update Time Table</h3>
							<%
								} else {
							%>
							<h3 class="text-center text-warning font-weight-bold">Add Time Table</h3>
							<%
								}
							%>
							<!--Body-->
...
<div class="col-sm-12">
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control input-group-addon "  name="examDate" placeholder="Enter Exam Date" id="udate5" readonly="readonly"
