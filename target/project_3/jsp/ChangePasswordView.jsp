...
<body>
	...
	<div class="col-sm-12">
      <div class="input-group">
		...
		<input class="form-control input-group-addon" type="password" name="oldpassword" placeholder="Enter password" 
	...
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("oldpassword", request)%></font></br>												
     ...
     <div class="col-sm-12">
      <div class="input-group">
		...
		<input class="form-control input-group-addon" type="password" name="newpassword" placeholder="Enter password" 
	value=<%=DataUtility.getString(request.getParameter("newpassword") == null ? ""
     ...
     <div class="col-sm-12">
      <div class="input-group">
		...
		<input class="form-control input-group-addon" type="password" name="confirmpassword" placeholder="Enter password" value=<%=DataUtility.getString(request.getParameter("confirmpassword") == null ? ""
