...
<body class="p4">
	...
	<div>
					...
					<div class="card input-group-addon ">
						<div class="card-body">
							<%
								...
								if (id>0) {
							%>
							<h3 class="text-center font-weight-bold text-warning">Update College</h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold text-warning">Add College</h3>
							<%
								}
							%>
							<!--Body-->
      ...
      <div class="input-group">
        ...
        <input type="text" name="name"  class="form-control input-group-addon "
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" name="address" class="form-control input-group-addon "
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" name="state" class="form-control input-group-addon " placeholder="Enter State" value="<%=DataUtility.getStringData(dto.getState())%>">
      </div>
    </div>	
    <font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("state", request)%></font></br>
      ...
      <div class="input-group">
       ...
       <input type="text" name="city" class="form-control input-group-addon " placeholder="Enter City" value="<%=DataUtility.getStringData(dto.getCity())%>">
      </div>
    </div>
