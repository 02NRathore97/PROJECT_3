...
<body class="p4">
					...
					<div class="card input-group-addon">
						<div class="card-body">
							<%
								...
								if (id>0) {
							%>
							<h3 class="text-center font-weight-bold text-warning">Update Student</h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold text-warning">Add Student</h3>
							<%
								}
							%>
							<!--Body-->
	...
	<div class="col-sm-12">
      <div class="input-group">
       ...
       <input type="text" name="emailId" class="form-control input-group-addon" placeholder="email Id"
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="datepicker" name="dob" class="form-control input-group-addon" placeholder="Date Of Birth" readonly="readonly" value="<%=DataUtility.getDateString(dto.getDob()) %>">
      </div>
    </div>	
