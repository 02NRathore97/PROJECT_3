...
<body >
				...
				<div class="col-md-4 mb-4">
					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							if (id>0)  {
							%>
							<h3 class="text-center  font-weight-bold text-warning">Update Subject</h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold  text-warning">Add Subject</h3>
							<%
								}
							%>
							<!--Body-->
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control input-group-addon" name="subjectName"  placeholder="Enter Subject Name" value="<%=DataUtility.getStringData(dto.getSubjectName())%>">
      </div>
    </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <textarea class="form-control input-group-addon " name="description" placeholder="Enter Description"
