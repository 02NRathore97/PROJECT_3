...
<body class="hm">
	...
	<div>
						...
						<div class="card-body">
							...
							<%
							  long id=DataUtility.getLong(request.getParameter("id"));
								...
								if (id>0) {
							%>
							<h3 class="text-center font-weight-bold text-warning">Update User</h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold text-warning">Add User</h3>
							<%
								}
							%>
							<!--Body-->
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control input-group-addon" name="firstName" placeholder="First Name" value="<%=DataUtility.getStringData(dto.getFirstName())%>">
      </div>
    </div>
    ...
    <div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control input-group-addon" name="lastName" placeholder="Last Name" value="<%=DataUtility.getStringData(dto.getLastName())%>">
      </div>
    </div>
    ...
    <div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="password" class="form-control input-group-addon" name="password" placeholder="password" value="<%=DataUtility.getStringData(dto.getPassword())%>">
      </div>
    </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="password" class="form-control input-group-addon" name="confirmPassword" placeholder="confirmPassword" value="<%=DataUtility.getStringData(dto.getConfirmPassword())%>">
      </div>
    </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control input-group-addon" id="defaultForm-email" name="emailId" placeholder="email Id" value="<%=DataUtility.getStringData(dto.getLogin())%>">
      </div>
    </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control input-group-addon" id="defaultForm-email" maxlength="10" name="mobileNo"placeholder="mobile No" value="<%=DataUtility.getStringData(dto.getMobileNo())%>">
      </div>
    </div>							
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="udate" name="dob" class="form-control input-group-addon" placeholder="Date Of Birth" readonly="readonly" value="<%=DataUtility.getDateString(dto.getDob()) %>">
      </div>
    </div>	
