...
<body class="p4">
					...
					<div class="card input-group-addon">
						<div class="card-body">
							<%
								...
								if (id>0) {
							%>
							<h3 class="text-center font-weight-bold text-warning">Update Faculty</h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold text-warning">Add Faculty</h3>
							<%
								}
							%>
							<!--Body-->
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" name="emailId" class="form-control input-group-addon" placeholder="Enter email Id" value="<%=DataUtility.getStringData(dto.getEmailId())%>">
      </div>
    </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input class="form-control input-group-addon" type="text" name="qualification" placeholder="Enter Qualification" value="<%=DataUtility.getStringData(dto.getQualification())%>">
      </div>
    </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="datepicker" name="dob" class="form-control input-group-addon" placeholder="Date Of Joining" readonly="readonly" value="<%=DataUtility.getDateString(dto.getDob()) %>">
      </div>
    </div>	
