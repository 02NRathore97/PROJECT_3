...
<body class="p4">
	...
	<div>
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							if (id>0)  {
							%>
							<h3 class="text-center font-weight-bold text-warning">Update Course</h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold text-warning">Add Course</h3>
							<%
								}
							%>
							<!--Body-->
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control input-group-addon" name="courseName" placeholder="Enter Course Name" value="<%=DataUtility.getStringData(dto.getCourseName())%>">
      </div>
    </div>
