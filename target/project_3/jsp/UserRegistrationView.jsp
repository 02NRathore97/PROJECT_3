				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon grad">
						<div class="card-body">
							...
							<h3 class="text-center font-weight-bold text-warning pb-2">User
								Registration</h3>
							<!--Body-->
							<div>
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control input-group-addon" name="firstName"
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control input-group-addon" name="lastName"
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control input-group-addon" id="defaultForm-email"
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" id="udate" name="dob" class="form-control input-group-addon"
